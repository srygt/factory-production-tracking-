...
"Panoya Kopyala"),b.i18n("buttons.copySuccess",{1:"Bir satırı panoya kopyaladı",_:"%d satırı panoya kopyaladı"},a.rows),2E3);return}catch(f){}}a=g("<span>"+b.i18n("buttons.copyKeys","Tablo verilerini sistem panonuza kopyalamak için <i> ctrl </ i> veya <i> ⌘ </ i> + <i> C </ i> tuşlarına basın.<br><br>İptal etmek için bu mesajı tıklayın veya kapat tuşuna basın.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Panoya Kopyala"),a,0);c[0].focus();c[0].select();var h=g(a).closest(".dt-button-info"),j=function(){h.off("click.buttons-copy");
