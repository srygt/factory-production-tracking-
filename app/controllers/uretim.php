        ...
        public function uretilenlerlistesi(){
                ...
                {   $sn = 0;
                    foreach ($kayitlar as $post)
                    {
                        ...
                        $matgisData['x']                = '<input type="checkbox" name="toplusec[]" id="toplusec[]" value="'.$post['tkid'].'">';
                        ...
                        if(session::get('AdminID')==4){
                            ...
                            $matgisData['durum']        = '<a  class="btn btn-info" href="'.SITE_URL.'/uretim/etiketyazdir/&id='.$post['tkid'].'"><label class="bg-info">YAZDIR</label></a>';
                        }
                        }else{ 
                            $matgisData['durum']        = '';
                        }
        ...
        $uretimdekilert = $model->uretimdekileritoplami($ID);
            for ($i=0; $i < $uretimdekilert; $i++) {
                ...
                $data = array(
                        ...
                        'barkodno'          => @$uretimdekiler[$i][serikodu], // Stok id
                        'stokdurumu'        => 1,                  
                        'miktar'            => 1,                      
                        'giristarihi'       => date("Y-m-d H:i:s"),                      
